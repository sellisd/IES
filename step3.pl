...
run("./addAge.pl 1 > ~/data/IES/analysis/iesdb/homIESdb1.tab", 1);
run("./addAge.pl 2 > ~/data/IES/analysis/iesdb/homIESdb2.tab", 1);
run("./addAge.pl 3 > ~/data/IES/analysis/iesdb/homIESdb3.tab", 1);
...
run("./nodePairs.py /home/dsellis/data/IES/analysis/phyldogT1/results/OutputSpeciesTree_ConsensusNumbered.tree > ~/data/IES/analysis/tables/spNodePairs1.dat", 1);
run("./nodePairs.py /home/dsellis/data/IES/analysis/phyldogT2/results/OutputSpeciesTree_ConsensusNumbered.tree > ~/data/IES/analysis/tables/spNodePairs2.dat", 1);
run("./nodePairs.py /home/dsellis/data/IES/analysis/phyldogT3/results/OutputSpeciesTree_ConsensusNumbered.tree > ~/data/IES/analysis/tables/spNodePairs3.dat", 1);

# calculate  node paths for each pair of speciation nodes
run("./nodePaths.py 1 > ~/data/IES/analysis/tables/nodePaths1.dat", 1);
run("./nodePaths.py 2 > ~/data/IES/analysis/tables/nodePaths2.dat", 1);
run("./nodePaths.py 3 > ~/data/IES/analysis/tables/nodePaths3.dat", 1);
...
run("./gainLoss.pl 1 > ~/data/IES/analysis/tables/gainLoss1.dat", 1);
run("./gainLoss.pl 2 > ~/data/IES/analysis/tables/gainLoss2.dat", 1);
run("./gainLoss.pl 3 > ~/data/IES/analysis/tables/gainLoss3.dat", 1);
