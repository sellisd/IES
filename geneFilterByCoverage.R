...
write.table(gppr, file = "~/data/IES/analysis/tables/gppr.filt", row.names = FALSE, col.names = FALSE, sep = "\t") 
write.table(gpbi, file = "~/data/IES/analysis/tables/gpbi.filt", row.names = FALSE, col.names = FALSE, sep = "\t") 
write.table(gpte, file = "~/data/IES/analysis/tables/gpte.filt", row.names = FALSE, col.names = FALSE, sep = "\t") 
write.table(gppe, file = "~/data/IES/analysis/tables/gppe.filt", row.names = FALSE, col.names = FALSE, sep = "\t") 
write.table(gpse, file = "~/data/IES/analysis/tables/gpse.filt", row.names = FALSE, col.names = FALSE, sep = "\t") 
write.table(gpoc, file = "~/data/IES/analysis/tables/gpoc.filt", row.names = FALSE, col.names = FALSE, sep = "\t") 
write.table(gptr, file = "~/data/IES/analysis/tables/gptr.filt", row.names = FALSE, col.names = FALSE, sep = "\t") 
write.table(gpso, file = "~/data/IES/analysis/tables/gpso.filt", row.names = FALSE, col.names = FALSE, sep = "\t") 
write.table(gpca, file = "~/data/IES/analysis/tables/gpca.filt", row.names = FALSE, col.names = FALSE, sep = "\t") 
dev.off()