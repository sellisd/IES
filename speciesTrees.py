...
t1.write(outfile = os.path.join(basePath, 'analysis', 'iesdb', 'speciesTree1.nhx'), features=['ND'], format_root_node = True)
t2.write(outfile = os.path.join(basePath, 'analysis', 'iesdb', 'speciesTree2.nhx'), features=['ND'], format_root_node = True)
t3.write(outfile = os.path.join(basePath, 'analysis', 'iesdb', 'speciesTree3.nhx'), features=['ND'], format_root_node = True)
t3b.write(outfile = os.path.join(basePath, 'analysis', 'iesdb', 'speciesTree3b.nhx'), features=['ND'], format_root_node = True)
